...
namespace MinimarketApp.Controllers
{
    public class ProveedoresController : Controller
    {
        ...
        public ProveedoresController(MinimarketContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,RucDni,RazonSocial,Telefono,Email,Direccion")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,RucDni,RazonSocial,Telefono,Email,Direccion")] Proveedore proveedore)
        {
